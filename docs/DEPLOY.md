...
$env:GATEWAY_UPSTREAM_URL = "<provider-base-url-WITHOUT-/v1>" # FOUNDER: e.g. https://integrate.api.nvidia.com — the gateway appends /v1/chat/completions itself (a trailing /v1 here would 404 upstream)
